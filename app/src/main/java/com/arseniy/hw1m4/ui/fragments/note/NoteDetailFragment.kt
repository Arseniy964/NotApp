...
import com.arseniy.hw1m4.databinding.FragmentNoteDetailBinding
...
class NoteDetailFragment : Fragment() {
    ...
    private lateinit var noteContainerLinear: LinearLayout
    ...
    private fun changeNoteBackgroundColor(color: Int) {
        ...
        editor.putInt("note_background_color", color)
        editor.apply()
    }
    ...
    override fun onResume() {
        super.onResume()
        val sharedPreferences = requireActivity().getSharedPreferences("NoteApp", Context.MODE_PRIVATE)
        val savedColor = sharedPreferences.getInt("note_background_color", Color.WHITE)
        noteContainerLinear.setBackgroundColor(savedColor)
        noteContainerRelative.setBackgroundColor(savedColor)
    }
